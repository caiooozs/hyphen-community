...
export const EcosystemBadgeCard = ({ icon, text }: EcosystemBadgeProps) => {
  return (
    <Card className="animate-on-scroll fluid-card-hover group relative rounded-lg bg-gradient-to-r from-slate-900 to-blue-950 p-4 shadow-xl shadow-blue-950/10 ring-0 hover:shadow-blue-500/15">
